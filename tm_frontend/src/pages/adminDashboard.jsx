        ...
        {isDashboard && (
          <>
            ...
            <div className="bg-gradient-to-r from-[#111111] to-[#1C1C1C] border border-[#D4AF37]/20 rounded-2xl shadow-xl p-6 mb-8 flex justify-between items-center">
              <div>
                <h1 className="text-4xl font-bold text-white"> Go Lanka Dashboard </h1>
                <p className="text-gray-400 mt-2"> Manage bookings, hotels, vehicles and tourism services </p>
              </div>
              <button className="bg-[#D4AF37] text-black px-6 py-3 rounded-xl font-semibold hover:scale-105 transition"> View Reports </button>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-[#2A2A2A] hover:bg-[#1C1C1C]">
                    ...
                    <td className="px-6 py-5 text-gray-300"> John Smith </td>
                    <td className="px-6 py-5 text-gray-300"> Beach Resort </td>
                    <td className="px-6 py-5 text-gray-300"> 2026-06-23 </td>
                    <td className="px-6 py-5"> <span className="bg-green-500/20 text-green-400 px-3 py-1 rounded-full"> Confirmed </span> </td>
                  </tr>

                  <tr className="border-b border-[#2A2A2A] hover:bg-[#1C1C1C]">
                    <td className="px-6 py-5 text-white">BK002</td>
                    <td className="px-6 py-5 text-gray-300"> Sarah Lee </td>
                    <td className="px-6 py-5 text-gray-300"> Ocean View Hotel </td>
                    <td className="px-6 py-5 text-gray-300"> 2026-06-23 </td>
                    <td className="px-6 py-5"> <span className="bg-yellow-500/20 text-yellow-400 px-3 py-1 rounded-full"> Pending </span> </td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="bg-[#141414] rounded-3xl p-6 border border-[#2A2A2A]">
                <h2 className="text-white text-2xl font-bold mb-4"> Booking Summary </h2>

                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-gray-400"> Hotel Bookings </span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400"> Tour Packages </span>
              ...
              <div className="bg-[#141414] rounded-3xl p-6 border border-[#2A2A2A]">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#D4AF37]"> LKR 2.5M </span>
                  </div>

                  <div className="flex justify-between">
                    <span className="text-gray-400"> Vehicle Revenue </span>
                    <span className="text-[#D4AF37]"> LKR 1.1M </span>
                  </div>

                  <div className="flex justify-between">
                    <span className="text-gray-400"> Package Revenue </span>
                    <span className="text-[#D4AF37]"> LKR 600K </span>
                  </div>

                  <div className="flex justify-between">
                    <span className="text-gray-400"> Total Revenue </span>
                    <span className="text-green-400 font-semibold"> LKR 4.2M </span>
                  </div>
                </div>
              </div>
            </div>
